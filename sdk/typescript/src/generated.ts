...
export class Drsg extends Client {
  ...
  planeCypher(params: { plane: string; query: string; embed?: string; embed_key_env?: string; embed_model?: string; params?: Record<string, unknown>; lean?: boolean }): Promise<Record<string, unknown>> {
